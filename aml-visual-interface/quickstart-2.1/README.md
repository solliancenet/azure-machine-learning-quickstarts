...
<img src="./images/01.png" width="70%" height="70%" title="Launch visual interface">
...
<img src="./images/02_1.png" width="70%" height="70%" title="Click on + New">

<img src="./images/02_2.png" width="70%" height="70%" title="Click on Upload from Local File">

<img src="./images/02_3.png" width="70%" height="70%" title="Click on Ok">
...
<img src="./images/03_1.png" width="70%" height="70%" title="Click on + Blank Experiment">

<img src="./images/03_2.png" width="70%" height="70%" title="Expand My Datasets">

<img src="./images/03_3.png" width="70%" height="70%" title="Drag and Drop My Dataset">
...
<img src="./images/04_1.png" width="70%" height="70%" title="Select Columns in Dataset Module">

<img src="./images/04_2.png" width="70%" height="70%" title="Exclude vendorID column">

<img src="./images/04_3.png" width="70%" height="70%" title="Clean Missing Data Module">

<img src="./images/04_4.png" width="70%" height="70%" title="Exclude non-numeric columns">

<img src="./images/04_4.png" width="70%" height="70%" title="Split Data Module">
...
<img src="./images/05_1.png" width="70%" height="70%" title="Boosted Decision Tree Regression Module">
...
<img src="./images/06_1.png" width="70%" height="70%" title="Train Model Module">

<img src="./images/06_2.png" width="70%" height="70%" title="Setup totalAmount as target column">
...
<img src="./images/07_1.png" width="70%" height="70%" title="Score Model Module">

<img src="./images/07_2.png" width="70%" height="70%" title="Evaluate Model Module">
...
<img src="./images/08_1.png" width="70%" height="70%" title="Click on Run Experiment">

<img src="./images/08_2.png" width="70%" height="70%" title="Select Compute and Run Experiment">
...
<img src="./images/09_1.png" width="70%" height="70%" title="Visualize the Model Predictions">

<img src="./images/09_2.png" width="70%" height="70%" title="Compare prediction to actual values">
...
<img src="./images/10_1.png" width="70%" height="70%" title="Visualize the Model Evaluation">

<img src="./images/10_2.png" width="70%" height="70%" title="Model Evaluation Metrics">
...
<img src="./images/11_1.png" width="70%" height="70%" title="Go to Run History">
...
<img src="./images/12_1.png" width="70%" height="70%" title="Right click on the Train Model module">

<img src="./images/12_2.png" width="70%" height="70%" title="Save the Trained Model">
...
<img src="./images/13_1.png" width="70%" height="70%" title="Create Predictive Experiment">

<img src="./images/13_2.png" width="70%" height="70%" title="Click on Run">
...
<img src="./images/14_1.png" width="70%" height="70%" title="Deploy Web Service">

<img src="./images/14_2.png" width="70%" height="70%" title="Deploy Web Service">
...
<img src="./images/15_1.png" width="70%" height="70%" title="Open the Web Service">

<img src="./images/15_2.png" width="70%" height="70%" title="Test the Web Service">
...
<img src="./images/16_1.png" width="70%" height="70%" title="Consume the Deployed Web Service">
...
<img src="./images/17_1.png" width="70%" height="70%" title="Delete the deployed Web Service">

<img src="./images/17_2.png" width="70%" height="70%" title="Delete the Compute Targets">
